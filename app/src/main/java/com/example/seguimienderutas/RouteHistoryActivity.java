...
public class RouteHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.history); // Usar el XML history.xml
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        ...
                        if (puntosRuta != null && !puntosRuta.isEmpty()) {
                            ...
                            Toast.makeText(RouteHistoryActivity.this, "No se encontraron puntos geográficos en esta ruta.", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(RouteHistoryActivity.this, "Ruta no encontrada", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(RouteHistoryActivity.this, "Error al cargar los detalles de la ruta: " + e.getMessage(), Toast.LENGTH_LONG).show();
                });
    }
}
