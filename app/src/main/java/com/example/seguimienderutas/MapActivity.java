...
public class MapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map); // No se cambia la referencia de R
        ...
        btnVerHistorial.setOnClickListener(v -> {
            Intent intent = new Intent(MapActivity.this, RouteHistoryActivity.class);
    ...
    private void habilitarUbicacion() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            fusedLocationClient.getLastLocation()
                    ...
                    .addOnFailureListener(e -> Toast.makeText(this, "Error al obtener la ubicación: " + e.getMessage(), Toast.LENGTH_LONG).show());
        }
    }
    ...
    private void mostrarDialogoParaNombreRuta() {
        ...
        builder.setPositiveButton("Aceptar", (dialog, which) -> {
            ...
            guardarRutaEnFirestore(nombreRuta.isEmpty() ? "Ruta " + routeStartTime : nombreRuta);
        });
    ...
    private void guardarRutaEnFirestore(String nombreRuta) {
        ...
        Route route = new Route(nombreRuta, user.getUid(), routeStartTime, geoPoints);
